...
class Encoder(nn.Module):
    ...
    def __init__(self, hparams):
        ...
        for _ in range(hparams.encoder_n_convolutions):
            ...
            speaker_embedding_layers.append(
                    EmbeddingTransformationLayer(hparams)
            )
        self.convolutions = nn.ModuleList(convolutions)
        self.speaker_embedding_layers = nn.ModuleList(speaker_embedding_layers)
    ...
    def forward(self, x, input_lengths, speaker_embedding):
        for conv, speaker_emb_layer in zip(self.convolutions,
                                     self.speaker_embedding_layers):
...
class Tacotron2Embedding(nn.Module):
    def __init__(self, hparams):
        super(Tacotron2Embedding, self).__init__()
